class finiteAutomate:
    def __init__(self, arrayLetters: set[str], arrayStates: set[str], arrayInitialStates: set[str], arrayFinalStates: set[str], arrayTransitions: set[str]):
        ...
        :param arrayLetters: set of letters used in the automata
        :param arrayStates: set of states used in the automata
        :param arrayInitialStates: set of initial states of the automata
        :param arrayFinalStates: set of final states of the automata
        :param arrayTransitions: set of transitions of the automata
...
def readFiniteAutomataFromFile(file):

    return

def displayFiniteAutomata(FA):
